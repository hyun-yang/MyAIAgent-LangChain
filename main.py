...
class MainWindow(QMainWindow):
    ...
    def initialize_ui(self):
        ...
        self._chat.documentModel.thread_started_signal.connect(self.show_result_info)
        self._chat.documentModel.document_preprocess_finished_signal.connect(self.show_result_info)

        self._chat.workflowModel.thread_started_signal.connect(self.show_result_info)
        self._chat.workflowModel.response_finished_signal.connect(self.show_result_info)
    ...
    def set_current_widget(self, index: MainWidgetIndex):
        self._settings.setValue('AI_Provider/llm', AIProviderName.OLLAMA.value)
